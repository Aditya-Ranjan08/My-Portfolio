      ...
      <div className='container mx-auto px-6 flex flex-col md:flex-row items-center justify-between'>
        ...
        <div className='md:w-1/2 mb-10 md:mb-0'>
          <h1 className='text-4xl md:text-6xl font-bold mb-4'>
            Hi, I'm <span className='text-purple'>Aditya Ranjan</span>
          </h1>
          ...
          <div className='flex space-x-4'>
            ...
            <a 
              ...
              download="Aditya_Ranjan_Resume.pdf"
        ...
        <div className='md:w-1/2 flex justify-center'>
          <div className='relative w-64 h-64 md:w-80 md:h-80'>
            ...
            <div className='absolute inset-0 rounded-full bg-gradient-to-r from-purple to-pink opacity-30 blur-2xl'></div>
            
            <div className='relative w-full h-full rounded-full border-4 border-purple/50 p-2 overflow-hidden'>
              <motion.img
                animate={{ y: [0, -10, 0] }}
                transition={{
                  duration: 4,
